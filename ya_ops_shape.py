...
# TODO, refactor into a single operator class
...
class MESH_OT_YA_ApplyChestCategory(Operator):
    ...
    def execute(self, context):
        ...
        if apply_mq:
            ...
            ApplyShapes.mute_chest_shapes(torso, self.key)
...
class MESH_OT_YA_ApplyLegSizes(Operator):
    ...
    def execute(self, context):
        ...
        if apply_mq:
            ...
            ApplyShapes.mute_leg_shapes(legs, self.key)
...
class MESH_OT_YA_ApplyGen(Operator):
    ...
    def execute(self, context):
        ...
        if apply_mq:
            ...
            ApplyShapes.mute_gen_shapes(Legs, self.key)
...
class MESH_OT_YA_ApplyNails(Operator):
    ...
    def execute(self, context):
        ...
        if apply_mq:
            ...
            ApplyShapes.mute_nail_shapes(hands, self.key)
...
classes = [
    ApplyShapes,
    MESH_OT_YA_ApplyChestCategory,
    MESH_OT_YA_ApplyOther,
    MESH_OT_YA_ApplyLegSizes,
    MESH_OT_YA_ApplyGen,
    MESH_OT_YA_ApplyNails,
    MESH_OT_YA_ApplyVisibility
